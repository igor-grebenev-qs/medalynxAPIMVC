...
namespace MedalynxAPI
{
    ...
    {
        public List<CohortEnums> GetCohortEnums(string enumItemId = "{00000000-0000-0000-0000-000000000000}")
        {
        ...
        public void AddItem(CohortEnums enumItem)
        {
            using (var dbContext = new MedialynxDbCohortEnumsContext()) {
        ...
        public void UpdateItem(CohortEnums enumItem)
        {
            using (var dbContext = new MedialynxDbCohortEnumsContext()) {
